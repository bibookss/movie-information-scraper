...
class Movie(BaseModel):
    ...
    directors = ManyToManyField(Director, backref='movies')
...
MovieDirector = Movie.directors.get_through_model()

db.create_tables([Genre, Movie, MovieGenre, Actor, Director, MovieActor, MovieDirector, Website])
